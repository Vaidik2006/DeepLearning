...
MODEL_PATH = "models/resnet50_grapevine_best.pth"
RESULTS_DIR = "results"
...
# ============================================================
# 13. UNFREEZE FINAL RESNET BLOCK
# ============================================================

# Fine-tune layer4, the deepest residual block.
...
plt.title(
    "ResNet50 - Test Set Confusion Matrix"
)
...
print("\n" + "=" * 60)
print("RESNET50 TRAINING AND TESTING COMPLETE")
print("=" * 60)
...
print("\nSaved graphs:")
print("results/resnet50_accuracy.png")
print("results/resnet50_loss.png")
