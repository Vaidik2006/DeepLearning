...
MODEL_PATH = "models/efficientnetb0_grapevine_best.pth"
RESULTS_DIR = "results"
...
# ============================================================
# 11. LOAD PRETRAINED EFFICIENTNETB0
# ============================================================
...
# ============================================================
# 13. UNFREEZE FINAL FEATURE BLOCK
# ============================================================

# Fine-tune the deepest EfficientNet feature block.
...
plt.title(
    "EfficientNetB0 - Test Set Confusion Matrix"
)
...
print("\n" + "=" * 60)
print("EFFICIENTNETB0 TRAINING AND TESTING COMPLETE")
print("=" * 60)
...
print("\nSaved graphs:")
print("results/efficientnetb0_accuracy.png")
print("results/efficientnetb0_loss.png")
print("results/efficientnetb0_confusion_matrix.png")
