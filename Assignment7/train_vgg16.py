...
MODEL_PATH = "models/vgg16_grapevine_best.pth"
RESULTS_DIR = "results"
...
# ============================================================
# 13. UNFREEZE LAST VGG16 BLOCK
# ============================================================

# VGG16 has five convolutional blocks.
# We fine-tune the final convolutional block.
...
plt.title(
    "VGG16 - Test Set Confusion Matrix"
)
...
print("\n" + "=" * 60)
print("VGG16 TRAINING AND TESTING COMPLETE")
print("=" * 60)
...
print("\nSaved graphs:")
print("results/vgg16_accuracy.png")
print("results/vgg16_loss.png")
print("results/vgg16_confusion_matrix.png")
